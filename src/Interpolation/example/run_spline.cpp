...
#include <Interpolation/Interp_spline.hpp>
#include "Function.h"

typedef spline_interpolate<>::vec_type vec;
...
int main( int argc, char * argv[] ) {
  ...
  //spline_interpolate<vec,vec> interp(xpts,fpts);
  spline_interpolate<Cheb_2 > interp(xpts,fpts);
  interp.update(df(-1.0),df(1.0));
